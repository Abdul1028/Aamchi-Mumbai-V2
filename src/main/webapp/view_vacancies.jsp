<%-- 
    Document   : view_vacancies
    Created on : Jan 25, 2023, 1:40:30 PM
    Author     : AbdulRasool
--%>
...
.anchorr:hover , .anchor2:hover{
  ...
  background-color: #bf3d42;
    ...
    <center><h1 style="font-family: TimesNewRoman; margin-top: 15px;">List of Vacancies available in Mumbai</h1></center>
...
<%
          ...
          ResultSet rs = st.executeQuery(query);      
                        ...
                        <form action="deleteVacancy.jsp">
                             <input class="anchorr3" type="text" placeholder="Enter Vacancy: " name="company_name">
    ...
    <center> <table>
			<tr>
				...
				<th id="tablehead">Role</th>
				<th id="tablehead">Email</th>
				<th id="tablehead">Contact</th>
				<th id="tablehead">Approx Salary</th>
			</tr>
