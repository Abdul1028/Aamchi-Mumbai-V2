<%-- 
    ...
    Created on : Jan 25, 2023, 1:53:53 PM
    Author     : AbdulRasool
--%>
    ...
    <body>
        ...
        try{
                ...
                if(session.getAttribute("isAdmin").equals("yes"))
                    {
                       try{
                            ...
                            PreparedStatement pst = con.prepareStatement("DELETE FROM vacancy WHERE company = ?;");
           ...
           %>
                ...
                <jsp:include page="view_vacancies.jsp" flush="true" > 
